...
Original file is located at
    https://colab.research.google.com/drive/1CTx8ILPefM1o1_xsjxndDnMGoLPSAZah
"""
...
!git config --global user.email "JaneCitizen@gmail.com" #Put your email here for your huggingface account
# Tip: using the same email as your huggingface.co account will link your commits to your profile
!git config --global user.name "Hobospider132" # Add your hugging face username
