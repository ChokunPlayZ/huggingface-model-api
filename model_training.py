...
!kaggle datasets download hobospider132/mahirushiina -f "mahiru_shiina.csv"

data = pd.read_csv('mahiru_shiina.csv')
...
sum(data.name == 'Mahiru')

CHARACTER_NAME = 'Mahiru'
...
# Normally use microsoft/DialoGPT-medium
...
class Args():
    def __init__(self):
        ...
        self.model_name_or_path = 'Hobospider132/DialoGPT-Mahiru-Proto'
        self.config_name = 'Hobospider132/DialoGPT-Mahiru-Proto'
        self.tokenizer_name = 'Hobospider132/DialoGPT-Mahiru-Proto'
...
for step in range(20):
    ...
    print("Mahiru Shiina: {}".format(tokenizer.decode(chat_history_ids[:, bot_input_ids.shape[-1]:][0], skip_special_tokens=True)))

"""## Push Model to Hugging Face"""

MY_MODEL_NAME = 'DialoGPT-Mahiru-Proto'
